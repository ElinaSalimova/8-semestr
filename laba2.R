...
boxplot(res1$Netweight.kg ~ as.factor(res1$country_factor) * as.factor(res1$Period.Desc),
...
bwplot( ~ Netweight.kg| as.factor(Period.Desc) * as.factor(country_factor), data = res1,
